...
describe("Tree", () => {
    describe("fromJson", () => {
        it("loads a model without the optional global key", () => {
        ...
        it("clamps an out of range selected index from the json", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
        ...
        it("tolerates a dangling subLayoutId", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
        ...
        it("throws a descriptive error for an invalid row child type", () => {
            expect(() =>
                Model.fromJson({
                    global: {},
                    layout: {
        ...
        it("throws a descriptive error for an invalid tabset child type", () => {
            expect(() =>
                Model.fromJson({
                    global: {},
                    layout: {
        ...
        it("accepts tabset and border children without an explicit type (legacy json)", () => {
            model = Model.fromJson({
                global: {},
                borders: [
                    {
                        type: "border",
                        location: "left",
                        children: [{ name: "borderless" } as any],
                    },
                ],
                layout: {
                    type: "row",
                    children: [
                        { type: "tabset", children: [{ name: "One" } as any] },
                    ],
                },
            });
            textRender(model);
        ...
        it("throws a descriptive error for an unknown border location", () => {
            expect(() =>
                Model.fromJson({
                    global: {},
                    borders: [
        ...
        it("clamps a negative selected index from the json to no selection", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
        ...
        it("ignores a subLayouts entry keyed as the main layout id", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
    ...
    describe("Robustness", () => {
        it("returns undefined for unknown layout ids", () => {
        ...
        it("ignores short weights arrays and unknown ids in adjustWeights", () => {
            model = Model.fromJson(twoTabs);
            textRender(model);
        ...
        it("clamps an out of range border selected index from json", () => {
            model = Model.fromJson({
                global: {},
                borders: [
        ...
        it("ignores unknown ids in setActiveTabset, maximizeToggle and updateNodeAttributes", () => {
            model = Model.fromJson(twoTabs);
            textRender(model);
            expect(() =>
                model.doAction(
                    Actions.setActiveTabset("unknownTabset", "badLayout"),
                ),
            ).not.toThrow();
            expect(() =>
                model.doAction(
                    Actions.maximizeToggle("unknownTabset", "badLayout"),
                ),
            ).not.toThrow();
            expect(() =>
                model.doAction(
                    Actions.updateNodeAttributes("unknownNode", { name: "x" }),
                ),
            ).not.toThrow();
        });

        it("keeps calculated max >= min when a tab has contradictory min/max attributes", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
            ...
            expect(tabset.getMaxWidth()).toBeGreaterThanOrEqual(
                tabset.getMinWidth(),
            );
            expect(root.getMaxWidth()).toBeGreaterThanOrEqual(
                root.getMinWidth(),
            );
        });

        it("getFirstTabSet returns undefined for an empty row instead of throwing", () => {
            model = Model.fromJson({
                global: {},
                layout: { type: "row", children: [] },
            });
        ...
        it("setRect fires resize only on a whole-pixel change", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
        ...
        // dockable: "restores horizontal scroll when vertical scroll is zero" moved to
        // tests/model/TabNodeMoveable.test.ts, which runs in jsdom with a layout controller
        // attached: the moveable element is now created through the controller, not `document`.

        it("deleting a tab removes nested sublayouts and closes their tabs", () => {
            model = Model.fromJson({
                global: {},
                layout: {
                    type: "row",
            ...
            const closed: string[] = [];
            (model.getNodeById("tB") as TabNode).setEventListener("close", () =>
                closed.push("B"),
            );
    ...
    describe("Actions", () => {
        describe("Add", () => {
            it("empty tabset", () => {
                ...
                doAction(
                    Actions.addTab(
                        { id: "2", name: "newtab1", component: "grid" },
                        "1",
                        DockLocation.CENTER,
                        -1,
                    ),
            ...
            describe("tabsets", () => {
                ...
                it("add to tabset center", () => {
                    ...
                    expect(tabs).equal(
                        "/ts0/t0[One],/ts0/t1[newtab1]*,/ts1/t0[Two]*",
                    );

                    const id1 = tabset("/ts1").getId();
                    doAction(
                        Actions.addTab(
                            { name: "newtab2", component: "grid" },
                            id1,
                            DockLocation.CENTER,
                            -1,
                        ),
                ...
                it("add to tabset at position", () => {
                    ...
                    expect(tabs).equal(
                        "/ts0/t0[newtab1]*,/ts0/t1[One],/ts1/t0[Two]*",
                    );
                ...
                it("add to tabset top", () => {
                    ...
                    expect(tabs).equal(
                        "/r0/ts0/t0[newtab1]*,/r0/ts1/t0[One]*,/ts1/t0[Two]*",
                    );
                ...
                it("add to tabset bottom", () => {
                    ...
                    expect(tabs).equal(
                        "/r0/ts0/t0[One]*,/r0/ts1/t0[newtab1]*,/ts1/t0[Two]*",
                    );
                ...
                it("add to tabset left", () => {
                    ...
                    expect(tabs).equal(
                        "/ts0/t0[newtab1]*,/ts1/t0[One]*,/ts2/t0[Two]*",
                    );
                ...
                it("add to tabset right", () => {
                    ...
                    expect(tabs).equal(
                        "/ts0/t0[One]*,/ts1/t0[newtab1]*,/ts2/t0[Two]*",
                    );
            ...
            describe("borders", () => {
                ...
                it("add to top border", () => {
                    ...
                    expect(tabsMatch(path)).equal(
                        "/b/top/t0[top1],/b/top/t1[newtab1]",
                    );
                    ...
                    expect(tabsMatch(path)).equal(
                        "/b/top/t0[newtab2],/b/top/t1[top1],/b/top/t2[newtab1]",
                    );
                    expect(tabsDontMatch(path)).equal(others);
                ...
                it("add to left border", () => {
                    ...
                    expect(tabsMatch(path)).equal(
                        "/b/left/t0[left1],/b/left/t1[newtab1]",
                    );
                    expect(tabsDontMatch(path)).equal(others);
                    ...
                    expect(tabsMatch(path)).equal(
                        "/b/left/t0[newtab2],/b/left/t1[left1],/b/left/t2[newtab1]",
                    );
                    expect(tabsDontMatch(path)).equal(others);
                ...
                it("add to right border", () => {
                    ...
                    expect(tabsMatch(path)).equal(
                        "/b/right/t0[right1],/b/right/t1[newtab1]",
                    );
                    expect(tabsDontMatch(path)).equal(others);
        ...
        describe("Move", () => {
            beforeEach(() => {
                ...
                textRender(model);
                expect(tabs).equal(
                    "/ts0/t0[One]*,/ts1/t0[Two]*,/ts2/t0[Three]*",
                );
            });
            ...
            it("move to center", () => {
                ...
                doAction(
                    Actions.moveNode(fromId, toId, DockLocation.CENTER, -1),
                );
                expect(tabs).equal(
                    "/ts0/t0[Two],/ts0/t1[One]*,/ts1/t0[Three]*",
                );
            });
            ...
            it("move to center position", () => {
                ...
                const toId = tab("/ts1").getId();
                doAction(
                    Actions.moveNode(fromId, toId, DockLocation.CENTER, 0),
                );
                expect(tabs).equal(
                    "/ts0/t0[One]*,/ts0/t1[Two],/ts1/t0[Three]*",
                );
            ...
            it("move to bottom", () => {
                ...
                const toId = tab("/ts1").getId();
                doAction(
                    Actions.moveNode(fromId, toId, DockLocation.BOTTOM, -1),
                );
                expect(tabs).equal(
                    "/r0/ts0/t0[Two]*,/r0/ts1/t0[One]*,/ts1/t0[Three]*",
                );
            });
            ...
            it("move to right", () => {
                ...
                const toId = tab("/ts1").getId();
                doAction(
                    Actions.moveNode(fromId, toId, DockLocation.RIGHT, -1),
                );
                expect(tabs).equal(
                    "/ts0/t0[Two]*,/ts1/t0[One]*,/ts2/t0[Three]*",
                );
            });
            ...
            it("dock onto a nested row uses the row's own orientation", () => {
                ...
                expect(tabs).equal(
                    "/ts0/t0[Three]*,/r1/ts0/t0[One]*,/r1/ts1/t0[Two]*",
                );
            });
            ...
            it("ignores moves into the dragged node's own subtree", () => {
                ...
                const before = tabs;
                expect(before).equal(
                    "/r0/ts0/t0[One]*,/r0/ts1/t0[Three]*,/ts1/t0[Two]*",
                );

                // dropping a row into its own descendant would corrupt the tree
                doAction(
                    Actions.moveNode("r1", "ts_inner", DockLocation.CENTER, -1),
                );
                doAction(
                    Actions.moveNode("r1", "ts_inner", DockLocation.TOP, -1),
                );
        ...
        describe("Selection preserved on insert", () => {
            ...
            it("add tab before selected keeps same tab selected (border)", () => {
                ...
                textRender(model);
                expect(tabs).equal(
                    "/b/top/t0[top1],/b/top/t1[top2]*,/ts0/t0[One]*",
                );
                ...
                expect(tabs).equal(
                    "/b/top/t0[New],/b/top/t1[top1],/b/top/t2[top2]*,/ts0/t0[One]*",
                );
            });
        ...
        describe("Splitter weight conservation", () => {
            ...
            it("conserves the total on a plain 3-child move in both directions", () => {
                ...
                const right = row.calculateSplit(
                    1,
                    350,
                    [250, 250, 250],
                    750,
        ...
        describe("Splitter bounds robustness", () => {
            ...
            it("ignores non-finite weights in adjustWeights", () => {
                ...
                expect((row.getChildren()[0] as TabSetNode).getWeight()).equal(
                    w0,
                );
                expect((row.getChildren()[1] as TabSetNode).getWeight()).equal(
                    5,
                );
            });
        });
            ...
            for (const location of locations) {
                it(`returns ordered finite bounds and a consistent split for the ${location} border`, () => {
                    ...
                    const border = model
                        .getBorderSet()
                        .getBorderMap()
                        .get(DockLocation.getByName(location)) as BorderNode;
        ...
        describe("Maximized tabset cleanup", () => {
            ...
            it("popout of maximized tabset clears maximized state on its own layout", () => {
                ...
                doAction(Actions.popoutTabset(tsA.getId()));
                expect(model.getMaximizedTabset(windowLayoutId)).equal(
                    undefined,
                );
            });
            ...
            it("moving an ancestor row of the maximized tabset clears maximized state", () => {
                ...
                doAction(
                    Actions.moveNode("r1", "ts_outer", DockLocation.RIGHT, -1),
                );
                expect(model.getMaximizedTabset()).equal(undefined);
        ...
        describe("Other Actions", () => {
            ...
            it("set tab attributes", () => {
                ...
                doAction(
                    Actions.updateNodeAttributes(tab("/ts1/t0").getId(), {
                        config: "newConfig",
                    }),
                );
...
describe("enableFloat attribute", () => {
    ...
    it("enableFloat is independent of enablePopout", () => {
        ...
        m.doAction(
            Actions.updateNodeAttributes("t0", { enableFloat: true } as any),
        );
    ...
    it("enableFloat inherits the tabEnableFloat global", () => {
        ...
        const tab = m.getNodeById("t0") as TabNode;
        m.doAction(
            Actions.updateModelAttributes({ tabEnableFloat: true } as any),
        );
        expect(tab.isEnableFloat()).toBe(true);
        expect(tab.isEnablePopout()).toBe(false);
    });
