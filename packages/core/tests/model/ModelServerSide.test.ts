// Ported from FlexLayout (https://github.com/caplin/FlexLayout), tests/ModelServerSide.test.ts.
...
describe("Model without a DOM", () => {
    it("loads, modifies and serializes a model", () => {
