// Ported from FlexLayout (https://github.com/caplin/FlexLayout), src/model/Actions.ts.
...
export class Actions {
    ...
    static addNode(
        ...
        return Actions.addTab(json, toNodeId, location, index, select);
    }
     ...
     * @returns {Action} the action
     */
    static setBorderType(
        borderNodeId: string,
        borderType: "split" | "overlay",
    ): Action {
        return new Action(Actions.SET_BORDER_TYPE, {
            node: borderNodeId,
            borderType,
        });
    }
     ...
     * @returns {Action} the action
     */
    static updateSubLayoutAttributes(
        layoutId: string,
        attributes: ISubLayoutAttributes,
    ): Action {
        return new Action(Actions.UPDATE_SUBLAYOUT_ATTRIBUTES, {
            layoutId: layoutId,
            json: attributes,
        });
    }
    ...
    static moveFloat(layoutId: string, rect: Rect): Action {
        return new Action(Actions.MOVE_FLOAT, {
            layoutId: layoutId,
            rect: rect,
        });
    }
    ...
    static popoutFloat(layoutId: string, rect?: IJsonRect): Action {
        return new Action(Actions.POPOUT_FLOAT, {
            layoutId: layoutId,
            rect: rect,
        });
    }
    ...
    static createPopout(
        ...
        return Actions.createSubLayout(layout, rect, type);
    }
     ...
     * @returns {Action} the action
     */
    static addTabToNewGroup(
        tabNodeId: string,
        name?: string,
        color?: string,
    ): Action {
        return new Action(Actions.ADD_TAB_TO_NEW_GROUP, {
            node: tabNodeId,
            name,
            color,
        });
...
export class Action {
    ...
    toJSON() {
        return this.userData === undefined
            ...
            : { type: this.type, data: this.data, userData: this.userData };
    }
}
