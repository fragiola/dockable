// Vendored from the Fragiola UI registry (https://ui.fragiola.com/r/input.json, source registry/atoms/fields/numeric.tsx). Do not edit: re-run scripts/vendor-fragiola.ts.
