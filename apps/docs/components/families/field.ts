// Vendored from the Fragiola UI registry (https://ui.fragiola.com/r/field.json, source registry/families/field.ts). Do not edit: re-run scripts/vendor-fragiola.ts.
