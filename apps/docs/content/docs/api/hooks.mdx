---
title: Hooks
description: useDockable, useTabSet, useSplitter, useDragNode and useDragSource - the lower layer under the primitives.
---
...
`UseDragNodeResult`, `UseDragSourceOptions`, `UseDragSourceResult`, and `GetLabel` (`(key: DockableLabel, ...args: (string | number)[]) => string
| undefined`).
