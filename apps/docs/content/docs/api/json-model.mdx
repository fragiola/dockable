...
Border attributes (`borders`, `border*` globals) and float, group and sub-layout-in-tab
attributes are read and saved, but borders, floats and tab groups are not rendered yet (see
